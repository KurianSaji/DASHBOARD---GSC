...
//    if([standardUserDefaults valueForKey:@"FB_URL"] != nil)
//    {
//        FBLoginDialog *dialog = [[FBLoginDialog alloc] init];
//        NSString *strURL = [NSString stringWithFormat:@"%@",[standardUserDefaults valueForKey:@"FB_URL"]];
//        NSURL *url = [[NSURL alloc]initWithString:strURL];
//        [dialog dialogDidSucceed:url];
//    }
